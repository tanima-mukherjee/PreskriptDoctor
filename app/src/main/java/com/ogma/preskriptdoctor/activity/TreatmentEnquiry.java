...
public class TreatmentEnquiry extends AppCompatActivity {

    private String TAG = TreatmentEnquiry.class.getSimpleName();
    private RecyclerAdapter recyclerAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_treatment_enquiry);
        ...
        findViewById(R.id.ll_schedules).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(TreatmentEnquiry.this, TreatmentSchedule.class));
            }
        });
    ...
    private class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_treatment_enquiry, parent, false);
...
//                ibEdit.setOnClickListener(this);
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(TreatmentEnquiry.this, TreatmentEnquiryDetails.class));
