...
public class GetReference extends AppCompatActivity {

    private String TAG = GetReference.class.getSimpleName();
    ...
    private class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_received_reference, parent, false);
