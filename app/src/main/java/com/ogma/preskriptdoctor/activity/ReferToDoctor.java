...
public class ReferToDoctor extends AppCompatActivity {

    private String TAG = ReferToDoctor.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_refer_to_doctor);
...
//                }
    ...
    private class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.ViewHolder> {
        ...
        @Override
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_refer_to_doctor, parent, false);
...
//                ibEdit.setOnClickListener(this);
            ...
            public void onClick(View view) {
                Log.e(TAG, "onClick at position: " + getAdapterPosition());
                startActivity(new Intent(ReferToDoctor.this, ReferToDoctorDetails.class));
//                if (view.getId() == ibEdit.getId()) {
//                    try {
//                        startActivityForResult(new Intent(getActivity(), CreateEventActivity.class)
//                                        .putExtra(CreateEventActivity.EXTRA_ID, jArr.getJSONObject(getAdapterPosition()).getString("group_id"))
