 ...
 */
public class StudyNotificationFragment extends Fragment {
    ...
    public StudyNotificationFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_study_notification, container, false);
