 ...
 */
public class StudyFeedFragment extends Fragment {

    private static final String TAG = StudyFeedFragment.class.getSimpleName();
    private RecyclerAdapter recyclerAdapter;
    private CoordinatorLayout coordinatorLayout;
    private SwipeRefreshLayout swipeRefreshLayout;


    public StudyFeedFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_study_feed, container, false);
...
//                }
        ...
        recyclerAdapter = new StudyFeedFragment.RecyclerAdapter();
        recyclerView.setAdapter(recyclerAdapter);

        return view;
    }

    private class RecyclerAdapter extends RecyclerView.Adapter<StudyFeedFragment.RecyclerAdapter.ViewHolder> {

        @Override
        public StudyFeedFragment.RecyclerAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_story_feed, parent, false);

            return new StudyFeedFragment.RecyclerAdapter.ViewHolder(view);
        }

        @Override
        public void onBindViewHolder(StudyFeedFragment.RecyclerAdapter.ViewHolder holder, int position) {
